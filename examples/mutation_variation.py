...
mutation_chances = np.arange(0.0005, 0.05, 0.005)
print(mutation_chances)
simulations_parameters_list = []
duplication_chance=0.001
for chance in mutation_chances:
    simulations_parameters_list.append((700, chance , 50))
...
plt.scatter(mutation_chances, avg_final_genotype_size_parameter, color="red")
plt.legend()
...
plt.savefig("mutation_variation.png")
plt.show()
